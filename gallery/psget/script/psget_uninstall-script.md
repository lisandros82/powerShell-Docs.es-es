...
---
# <a name="uninstall-script"></a><span data-ttu-id="edc84-103">Uninstall-Script</span><span class="sxs-lookup"><span data-stu-id="edc84-103">Uninstall-Script</span></span>

<span data-ttu-id="edc84-104">Desinstala un archivo de script instalado mediante PowerShellGet.</span><span class="sxs-lookup"><span data-stu-id="edc84-104">Uninstalls a script file which was installed using PowerShellGet.</span></span>

## <a name="description"></a><span data-ttu-id="edc84-105">Descripción</span><span class="sxs-lookup"><span data-stu-id="edc84-105">Description</span></span>

<span data-ttu-id="edc84-106">El cmdlet Uninstall-Script desinstala los archivos de script especificados que se instalaron desde el repositorio en línea.</span><span class="sxs-lookup"><span data-stu-id="edc84-106">The Uninstall-Script cmdlet uninstalls the specified script files which were installed from the online repository.</span></span>

## <a name="cmdlet-syntax"></a><span data-ttu-id="edc84-107">Sintaxis de cmdlet</span><span class="sxs-lookup"><span data-stu-id="edc84-107">Cmdlet syntax</span></span>

```powershell
Get-Command -Name Uninstall-Script -Module PowerShellGet -Syntax
```
## <a name="cmdlet-online-help-reference"></a><span data-ttu-id="edc84-108">Referencia de la ayuda en línea de cmdlet</span><span class="sxs-lookup"><span data-stu-id="edc84-108">Cmdlet online help reference</span></span>

[<span data-ttu-id="edc84-109">Uninstall-Script</span><span class="sxs-lookup"><span data-stu-id="edc84-109">Uninstall-Script</span></span>](http://go.microsoft.com/fwlink/?LinkId=619789)

## <a name="example-commands"></a><span data-ttu-id="edc84-110">Comandos de ejemplo</span><span class="sxs-lookup"><span data-stu-id="edc84-110">Example commands</span></span>
