...
En la tabla siguiente se muestran los elementos de la interfaz de usuario de Galería de PowerShell que controla el editor. Cada elemento indica si se puede controlar por el manifiesto del módulo o del script.
...
La página Editar elemento de Galería de PowerShell permite a los editores cambiar algunos de los campos que se muestran para un elemento, en concreto:
