...
Para cada módulo, también existen campos de metadatos asociados. Con el fin de mostrar metadatos correctamente en la Galería de PowerShell, puede usar Update-ModuleManifest para rellenar dichos campos en PrivateData.
```powershell
