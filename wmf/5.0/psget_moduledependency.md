...
---
# <a name="installation-of-module-dependencies"></a>Instalación de dependencias de módulo
...
**Instalar un módulo con dependencias:**
```powershell
PS C:\\windows\\system32&gt; Get-InstalledModule
