...
Este ejemplo muestra cómo escribir un cmdlet cuyos parámetros tienen alias y cuyos parámetros admiten caracteres comodín. Este cmdlet es similar a la `Stop-Process` cmdlet proporcionado por Windows PowerShell 2.0.

### <a name="how-to-build-the-sample-by-using-visual-studio"></a>Cómo generar el ejemplo mediante Visual Studio.

1. Con Windows PowerShell 2.0 instalado el SDK, vaya a la carpeta StopProcessSample03. La ubicación predeterminada es C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\StopProcessSample03.
...
- Agregar alias a las declaraciones de parámetro...

- Agregar compatibilidad con caracteres comodín para los parámetros.

## <a name="example"></a>Ejemplo

En este ejemplo se muestra cómo declarar los alias de parámetro y admiten caracteres comodín.
