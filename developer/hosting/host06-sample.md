...
ms.locfileid: "62082879"
---
# <a name="host06-sample"></a><span data-ttu-id="84eb7-102">Ejemplo Host06</span><span class="sxs-lookup"><span data-stu-id="84eb7-102">Host06 Sample</span></span>

<span data-ttu-id="84eb7-103">En este ejemplo se muestra cómo crear una aplicación host basada en consola interactiva que lee los comandos de la línea de comandos, ejecuta los comandos y, a continuación, muestra los resultados en la consola.</span><span class="sxs-lookup"><span data-stu-id="84eb7-103">This sample shows how to build an interactive console-based host application that reads commands from the command line, executes the commands, and then displays the results to the console.</span></span> <span data-ttu-id="84eb7-104">Además, este ejemplo utiliza las API de Tokenizer para especificar el color del texto que el usuario ha escrito.</span><span class="sxs-lookup"><span data-stu-id="84eb7-104">In addition, this sample uses the Tokenizer APIs to specify the color of the text that is entered by the user.</span></span>

## <a name="requirements"></a><span data-ttu-id="84eb7-105">Requisitos</span><span class="sxs-lookup"><span data-stu-id="84eb7-105">Requirements</span></span>

- <span data-ttu-id="84eb7-106">Este ejemplo requiere Windows PowerShell 2.0.</span><span class="sxs-lookup"><span data-stu-id="84eb7-106">This sample requires Windows PowerShell 2.0.</span></span>

- <span data-ttu-id="84eb7-107">Esta aplicación se debe ejecutar en modo con privilegios elevados (ejecutar como administrador).</span><span class="sxs-lookup"><span data-stu-id="84eb7-107">This application must be run in elevated mode (Run as administrator).</span></span>

## <a name="demonstrates"></a><span data-ttu-id="84eb7-108">Muestra</span><span class="sxs-lookup"><span data-stu-id="84eb7-108">Demonstrates</span></span>

- <span data-ttu-id="84eb7-109">Creación de un host personalizado cuyas clases se derivan de la [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) (clase), el [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) clase y el [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) clase.</span><span class="sxs-lookup"><span data-stu-id="84eb7-109">Creating a custom host whose classes derive from the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class, the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class, and the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class.</span></span>

- <span data-ttu-id="84eb7-110">Creación de una aplicación de consola que usa estas clases de host para crear un shell interactivo de Windows PowerShell.</span><span class="sxs-lookup"><span data-stu-id="84eb7-110">Building a console application that uses these host classes to build an interactive Windows PowerShell shell.</span></span>

- <span data-ttu-id="84eb7-111">Creación de un `$profile` variable y cargar los siguientes perfiles.</span><span class="sxs-lookup"><span data-stu-id="84eb7-111">Creating a `$profile` variable and loading the following profiles.</span></span>

  - <span data-ttu-id="84eb7-112">usuario actual, el host actual</span><span class="sxs-lookup"><span data-stu-id="84eb7-112">current user, current host</span></span>

  - <span data-ttu-id="84eb7-113">usuario actual, todos los hosts</span><span class="sxs-lookup"><span data-stu-id="84eb7-113">current user, all hosts</span></span>

  - <span data-ttu-id="84eb7-114">todos los usuarios, host actual</span><span class="sxs-lookup"><span data-stu-id="84eb7-114">all users, current host</span></span>

  - <span data-ttu-id="84eb7-115">todos los usuarios, todos los hosts</span><span class="sxs-lookup"><span data-stu-id="84eb7-115">all users, all hosts</span></span>

- <span data-ttu-id="84eb7-116">Implemente el [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interfaz.</span><span class="sxs-lookup"><span data-stu-id="84eb7-116">Implement the [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interface.</span></span>

- <span data-ttu-id="84eb7-117">Implemente el [System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession) interfaz para admitir la comunicación remota interactiva mediante el [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) y [ Exit-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlets.</span><span class="sxs-lookup"><span data-stu-id="84eb7-117">Implement the [System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession) interface to support interactive remoting by using the [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) and [Exit-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlets.</span></span>

- <span data-ttu-id="84eb7-118">Usar la API acortar para colorear la línea de comandos como se escribe.</span><span class="sxs-lookup"><span data-stu-id="84eb7-118">Use the Tokenize API to colorize the command line as it is typed.</span></span>

## <a name="example"></a><span data-ttu-id="84eb7-119">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="84eb7-119">Example</span></span>

 <span data-ttu-id="84eb7-120">En este ejemplo permite al usuario que escriba los comandos en una línea de comandos, procesa los comandos y, a continuación, imprime los resultados.</span><span class="sxs-lookup"><span data-stu-id="84eb7-120">This example allows the user to enter commands at a command line, processes those commands, and then prints out the results.</span></span>
...
## <a name="example"></a><span data-ttu-id="84eb7-121">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="84eb7-121">Example</span></span>

 <span data-ttu-id="84eb7-122">El código siguiente es la implementación de la [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) clase que se usa esta aplicación host.</span><span class="sxs-lookup"><span data-stu-id="84eb7-122">The following code is the implementation of the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class that is used by this host application.</span></span> <span data-ttu-id="84eb7-123">Los elementos que no se implementan producirán una excepción o no devuelven nada.</span><span class="sxs-lookup"><span data-stu-id="84eb7-123">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="example"></a><span data-ttu-id="84eb7-124">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="84eb7-124">Example</span></span>

 <span data-ttu-id="84eb7-125">El código siguiente es la implementación de la [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) clase que se usa esta aplicación host.</span><span class="sxs-lookup"><span data-stu-id="84eb7-125">The following code is the implementation of the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class that is used by this host application.</span></span>
...
## <a name="example"></a><span data-ttu-id="84eb7-126">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="84eb7-126">Example</span></span>

 <span data-ttu-id="84eb7-127">El código siguiente es la implementación de la [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) clase que se usa esta aplicación host.</span><span class="sxs-lookup"><span data-stu-id="84eb7-127">The following code is the implementation of the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class that is used by this host application.</span></span> <span data-ttu-id="84eb7-128">Los elementos que no se implementan producirán una excepción o no devuelven nada.</span><span class="sxs-lookup"><span data-stu-id="84eb7-128">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="example"></a><span data-ttu-id="84eb7-129">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="84eb7-129">Example</span></span>

 <span data-ttu-id="84eb7-130">El siguiente código lee la línea de comandos y los colores del texto mientras se escribe.</span><span class="sxs-lookup"><span data-stu-id="84eb7-130">The following code reads the command line and colors the text as it is entered.</span></span> <span data-ttu-id="84eb7-131">Los tokens se determinan mediante el uso de la [System.Management.Automation.Psparser.Tokenize\*](/dotnet/api/System.Management.Automation.PSParser.Tokenize) método.</span><span class="sxs-lookup"><span data-stu-id="84eb7-131">Tokens are determined by using the [System.Management.Automation.Psparser.Tokenize\*](/dotnet/api/System.Management.Automation.PSParser.Tokenize) method.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="84eb7-132">Véase también</span><span class="sxs-lookup"><span data-stu-id="84eb7-132">See Also</span></span>

 [<span data-ttu-id="84eb7-133">System.Management.Automation.Host.PSHost</span><span class="sxs-lookup"><span data-stu-id="84eb7-133">System.Management.Automation.Host.PSHost</span></span>](/dotnet/api/System.Management.Automation.Host.PSHost)

 [<span data-ttu-id="84eb7-134">System.Management.Automation.Host.Pshostuserinterface</span><span class="sxs-lookup"><span data-stu-id="84eb7-134">System.Management.Automation.Host.Pshostuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)

 [<span data-ttu-id="84eb7-135">System.Management.Automation.Host.Pshostrawuserinterface</span><span class="sxs-lookup"><span data-stu-id="84eb7-135">System.Management.Automation.Host.Pshostrawuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)
