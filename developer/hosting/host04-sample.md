---
title: Ejemplo Host04 | Microsoft Docs
ms.custom: ''
ms.date: 09/13/2016
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "56863751"
---
# <a name="host04-sample"></a><span data-ttu-id="2a32f-102">Ejemplo Host04</span><span class="sxs-lookup"><span data-stu-id="2a32f-102">Host04 Sample</span></span>

<span data-ttu-id="2a32f-103">En este ejemplo se muestra cómo crear una aplicación host basada en consola interactiva que lee los comandos de la línea de comandos, ejecuta los comandos y, a continuación, muestra los resultados en la consola.</span><span class="sxs-lookup"><span data-stu-id="2a32f-103">This sample shows how to build an interactive console-based host application that reads commands from the command line, executes the commands, and then displays the results to the console.</span></span> <span data-ttu-id="2a32f-104">Esta aplicación host también permite mostrar avisos para que el usuario pueda especificar varias opciones.</span><span class="sxs-lookup"><span data-stu-id="2a32f-104">This host application also supports displaying prompts that allow the user to specify multiple choices.</span></span>

## <a name="requirements"></a><span data-ttu-id="2a32f-105">Requisitos</span><span class="sxs-lookup"><span data-stu-id="2a32f-105">Requirements</span></span>

 <span data-ttu-id="2a32f-106">Este ejemplo requiere Windows PowerShell 2.0.</span><span class="sxs-lookup"><span data-stu-id="2a32f-106">This sample requires Windows PowerShell 2.0.</span></span>

## <a name="demonstrates"></a><span data-ttu-id="2a32f-107">Demostraciones</span><span class="sxs-lookup"><span data-stu-id="2a32f-107">Demonstrates</span></span>

- <span data-ttu-id="2a32f-108">Creación de un host personalizado cuyas clases se derivan de la [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) (clase), el [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) clase y el [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) clase.</span><span class="sxs-lookup"><span data-stu-id="2a32f-108">Creating a custom host whose classes derive from the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class, the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class, and the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class.</span></span>

- <span data-ttu-id="2a32f-109">Creación de una aplicación de consola que usa estas clases de host para crear un shell interactivo de Windows PowerShell.</span><span class="sxs-lookup"><span data-stu-id="2a32f-109">Building a console application that uses these host classes to build an interactive Windows PowerShell shell.</span></span>

- <span data-ttu-id="2a32f-110">Creación de un `$profile` variable y cargar los siguientes perfiles.</span><span class="sxs-lookup"><span data-stu-id="2a32f-110">Creating a `$profile` variable and loading the following profiles.</span></span>

  - <span data-ttu-id="2a32f-111">usuario actual, el host actual</span><span class="sxs-lookup"><span data-stu-id="2a32f-111">current user, current host</span></span>

  - <span data-ttu-id="2a32f-112">usuario actual, todos los hosts</span><span class="sxs-lookup"><span data-stu-id="2a32f-112">current user, all hosts</span></span>

  - <span data-ttu-id="2a32f-113">todos los usuarios, host actual</span><span class="sxs-lookup"><span data-stu-id="2a32f-113">all users, current host</span></span>

  - <span data-ttu-id="2a32f-114">todos los usuarios, todos los hosts</span><span class="sxs-lookup"><span data-stu-id="2a32f-114">all users, all hosts</span></span>

- <span data-ttu-id="2a32f-115">Implemente el [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interfaz.</span><span class="sxs-lookup"><span data-stu-id="2a32f-115">Implement the [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interface.</span></span>

## <a name="example"></a><span data-ttu-id="2a32f-116">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="2a32f-116">Example</span></span>

 <span data-ttu-id="2a32f-117">En este ejemplo permite al usuario que escriba los comandos en una línea de comandos, procesa los comandos y, a continuación, imprime los resultados.</span><span class="sxs-lookup"><span data-stu-id="2a32f-117">This example allows the user to enter commands at a command line, processes those commands, and then prints out the results.</span></span>
...
## <a name="example"></a><span data-ttu-id="2a32f-118">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="2a32f-118">Example</span></span>

 <span data-ttu-id="2a32f-119">El código siguiente es la implementación de la [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) clase que se usa esta aplicación host.</span><span class="sxs-lookup"><span data-stu-id="2a32f-119">The following code is the implementation of the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class that is used by this host application.</span></span> <span data-ttu-id="2a32f-120">Los elementos que no se implementan producirán una excepción o no devuelven nada.</span><span class="sxs-lookup"><span data-stu-id="2a32f-120">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="example"></a><span data-ttu-id="2a32f-121">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="2a32f-121">Example</span></span>

 <span data-ttu-id="2a32f-122">El código siguiente es la implementación de la [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) clase que se usa esta aplicación host.</span><span class="sxs-lookup"><span data-stu-id="2a32f-122">The following code is the implementation of the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class that is used by this host application.</span></span>
...
## <a name="example"></a><span data-ttu-id="2a32f-123">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="2a32f-123">Example</span></span>

 <span data-ttu-id="2a32f-124">El código siguiente es la implementación de la [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) clase que se usa esta aplicación host.</span><span class="sxs-lookup"><span data-stu-id="2a32f-124">The following code is the implementation of the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class that is used by this host application.</span></span> <span data-ttu-id="2a32f-125">Los elementos que no se implementan producirán una excepción o no devuelven nada.</span><span class="sxs-lookup"><span data-stu-id="2a32f-125">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="2a32f-126">Véase también</span><span class="sxs-lookup"><span data-stu-id="2a32f-126">See Also</span></span>

 [<span data-ttu-id="2a32f-127">System.Management.Automation.Host.PSHost</span><span class="sxs-lookup"><span data-stu-id="2a32f-127">System.Management.Automation.Host.PSHost</span></span>](/dotnet/api/System.Management.Automation.Host.PSHost)

 [<span data-ttu-id="2a32f-128">System.Management.Automation.Host.Pshostuserinterface</span><span class="sxs-lookup"><span data-stu-id="2a32f-128">System.Management.Automation.Host.Pshostuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)

 [<span data-ttu-id="2a32f-129">System.Management.Automation.Host.Pshostrawuserinterface</span><span class="sxs-lookup"><span data-stu-id="2a32f-129">System.Management.Automation.Host.Pshostrawuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)
