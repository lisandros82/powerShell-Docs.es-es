...
---
# <a name="runspace02-vbnet-code-sample"></a>Ejemplo de código Runspace02 (VB.NET)

Este es el código fuente VB.NET del ejemplo Runspace02. Este ejemplo se utiliza el [System.Management.Automation.Runspaceinvoke](/dotnet/api/System.Management.Automation.RunspaceInvoke) clase para ejecutar el `Get-Process` cmdlet sincrónicamente. Enlace de datos y de Windows Forms, a continuación, se usan para mostrar los resultados en un control DataGridView.
