---
title: GetProc05 código de ejemplo (VB.NET) | Microsoft Docs
ms.custom: ''
ms.date: 09/13/2016
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "56853511"
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="f09b3-102">Código de ejemplo GetProc05 (VB.NET)</span><span class="sxs-lookup"><span data-stu-id="f09b3-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="f09b3-103">Este es el código VB.NET completando para el cmdlet de ejemplo GetProc05.</span><span class="sxs-lookup"><span data-stu-id="f09b3-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="f09b3-104">Véase también</span><span class="sxs-lookup"><span data-stu-id="f09b3-104">See Also</span></span>

[<span data-ttu-id="f09b3-105">Windows PowerShell SDK</span><span class="sxs-lookup"><span data-stu-id="f09b3-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)