...
Después de haber completado todos los pasos necesarios para crear un servicio web de IIS Management OData, debe implementarla como una aplicación web en IIS.

## <a name="deploying-the-web-service"></a>Implementación del servicio web

Complete los pasos siguientes para implementar el servicio web de IIS Management OData.

1. Cree un directorio para la aplicación web en IIS `WWWRoot` directory.
...
3. Crear un identificador de sitio.
...
Los siguientes scripts de Windows PowerShell muestran cómo implementar un servicio web de IIS Management OData.
