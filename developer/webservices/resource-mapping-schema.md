...
---
# <a name="resource-mapping-schema"></a>Esquema de asignación de recursos

Extensión IIS Management OData usa archivos XML para definir la asignación de recursos. El esquema XSD siguiente define el esquema utilizado para estos archivos.

## <a name="resource-mapping-file-xsd"></a>Archivo XSD de asignación de recursos

El esquema XSD siguiente define el esquema para archivos de asignación de recursos de extensión IIS Management OData.
