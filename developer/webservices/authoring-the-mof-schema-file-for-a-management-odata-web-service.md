...
Definir los recursos que expone el servicio web de IIS Management OData mediante la creación de un archivo MOF que utiliza el esquema del recurso público. Cada recurso se define como una clase en el archivo y las propiedades se definen como miembros de clase. Para obtener más información sobre el esquema utilizado en el archivo MOF, consulte [esquema recurso público](./public-resource-schema.md).

## <a name="example-mof-file"></a>Archivo MOF de ejemplo

El siguiente archivo define los recursos de proceso y servicio. Cada uno de estos recursos corresponde a un objeto que puede administrarse mediante un conjunto de cmdlet de Windows PowerShell. Las propiedades corresponden a los parámetros utilizados por los cmdlets.

Cada uno de los dos recursos contiene propiedades que son del tipo complejo. Los tipos complejos se definen como las clases modificación con el `ComplexType` calificador.
