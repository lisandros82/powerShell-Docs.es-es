...
Especifica un tipo .NET que usa esta definición del control. Este elemento se usa al definir un control común que puede usarse en todas las vistas en el archivo de formato.
