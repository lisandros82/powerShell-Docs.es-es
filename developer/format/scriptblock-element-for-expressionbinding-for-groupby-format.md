...
---
# <a name="scriptblock-element-for-expressionbinding-for-groupby-format"></a>Elemento ScriptBlock para ExpressionBinding for GroupBy (formato)

Especifica la secuencia de comandos cuyo valor se muestra el control. Este elemento se usa al definir cómo se muestra un nuevo grupo de objetos.
