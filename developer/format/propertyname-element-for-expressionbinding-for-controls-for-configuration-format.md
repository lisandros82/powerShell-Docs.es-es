...
Especifica la propiedad de .NET cuyo valor se muestra el control común. Este elemento se usa al definir un control común que puede usarse en todas las vistas en el archivo de formato.
