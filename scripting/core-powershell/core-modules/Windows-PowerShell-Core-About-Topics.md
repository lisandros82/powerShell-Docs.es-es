...
|Tema|Descripción|
|---------|---------------|
|[about_Aliases](https://technet.microsoft.com/en-us/library/638c1890-4425-4a3e-8432-09015672f234)|Describe los nombres alternativos de los cmdlets y los comandos en Windows PowerShell.|
|[about_Arithmetic_Operators [v4]](https://technet.microsoft.com/en-us/library/e471f288-0182-4474-a2de-aa8353c3b09b)|Describe los operadores que realizan operaciones aritméticas en Windows PowerShell.|
|[about_Arrays [v4]](https://technet.microsoft.com/en-us/library/beca4530-77f9-4c0f-817b-ec7a48cdcf9d)|Describe las matrices, una estructura de datos compacta para almacenar elementos de datos.|
|[about_Assignment_Operators [v4]](https://technet.microsoft.com/en-us/library/ac2e399d-9cdc-422c-8b44-7746d93d1db5)|Describe los operadores que asignan valores a variables.|
|[about_Automatic_Variables [v4]](https://technet.microsoft.com/en-us/library/68bc622f-eb7e-4cf5-9c56-a289737efc99)|Describe las variables automáticas, que almacenan información de estado para Windows PowerShell.|
|[about_Break [v4]](https://technet.microsoft.com/en-us/library/fb810374-761e-46f2-8748-eac12557cf54)|Explica cómo usar la instrucción **Break**, que permite salir inmediatamente de las instrucciones **Foreach**, **For**, **While**, **Do** y **Switch**.|
|[about_Checkpoint-Workflow](https://technet.microsoft.com/en-us/library/3a309488-1e7a-4807-b83b-dedbeac3ee1c)|Describe la actividad Checkpoint-Workflow, que toma un punto de comprobación en un flujo de trabajo.|
...
|[about_Comment_Based_Help [v4]](https://technet.microsoft.com/en-us/library/c270e198-6da2-4825-b6eb-35d5c8a5cf3d)|Explica cómo escribir temas de ayuda basados en comentarios para funciones scripts.|
...
|[about_Data_Sections [v4]](https://technet.microsoft.com/en-us/library/d2d76c2d-ad7c-41fb-b745-7bdda8df131e)|Describe la sección **Data** de los scripts, que está diseñada para aislar los datos de la lógica del código.|
|[about_DesiredStateConfiguration](https://technet.microsoft.com/en-us/library/f1b54875-bf62-4a04-bf50-470791b1dfca)|Describa la característica Configuración de estado deseado de Windows PowerShell, que ayuda a garantizar una configuración coherente en varios nodos remotos administrados.|
|[about_Debuggers [v4]](https://technet.microsoft.com/en-us/library/2b2ce8b3-f881-4528-bd30-f453dea06755)|Describe el depurador de scripts de Windows PowerShell, un conjunto de cmdlets para depurar scripts y funciones.|
|[about_Do [v4]](https://technet.microsoft.com/en-us/library/d1f65c4e-6231-44e2-b21c-78a91845ad6c)|Describe la instrucción Do, que se ejecuta un bloque de script una o varias veces en función de una condición While o Until.|
|[about_Environment_Variables [v4]](https://technet.microsoft.com/en-us/library/998c8863-3794-42a8-8971-a5cadef72772)|Explica cómo obtener acceso a variables de entorno de Windows en Windows PowerShell.|
|[about_Escape_Characters [v4]](https://technet.microsoft.com/en-us/library/576ca013-c4ca-4ade-bf46-b0d1ce2c778f)|Presenta el carácter de escape en Windows PowerShell (\`) y explica su efecto.|
|[about_Eventlogs [v4]](https://technet.microsoft.com/en-us/library/8b5279cd-daf1-4ed1-8575-2df4baf7042d)|Describe el registro de eventos de Windows PowerShell en el visor de eventos.|
|[about_Execution_Policies [v4]](https://technet.microsoft.com/en-us/library/347708dc-1515-4d74-978b-8334603472e6)|Describe las directivas de ejecución de Windows PowerShell y explica cómo administrarlas.|
|[about_For [v4]](https://technet.microsoft.com/en-us/library/a2eb48d6-7d47-4087-a8d6-deb1d029a957)|Describe el bucle **For** en Windows PowerShell.|
|[about_ForEach [v4]](https://technet.microsoft.com/en-us/library/50b1bd2b-d061-4d60-84d9-33e422dba357)|Describe la instrucción **ForEach**, que actúa en cada elemento de una colección.|
...
|[about_Group_Policy_Settings](https://technet.microsoft.com/en-us/library/2fa263de-6bb2-406e-b660-cd5a934c7bb6)|Describe la configuración de la directiva de grupo para Windows PowerShell.|
|[about_Hash_Tables [v4]](https://technet.microsoft.com/en-us/library/161a2a45-7a6b-44fb-b669-fb9ff0dbae3d)|Explica cómo crear, usar y ordenar tablas hash en Windows PowerShell.|
|[about_History [v4]](https://technet.microsoft.com/en-us/library/46fa1b2e-c079-4e94-a87e-511ee50b347a)|Explica cómo obtener y ejecutar comandos desde el historial de comandos.|
|[about_If [v4]](https://technet.microsoft.com/en-us/library/acf971f7-d844-4160-b347-435178c8a6fa)|Describe la instrucción **If**, que establece las condiciones de una acción.|
|[about_InlineScript](https://technet.microsoft.com/en-us/library/f88ed5a9-02d6-4bf0-a031-61198e1e7291)|Describe la actividad del flujo de trabajo de InlineScript.|
|[about_Jobs [v4]](https://technet.microsoft.com/en-us/library/7362512a-8a4e-4575-b2ea-a740e5c4f002)|Describe los trabajos en segundo plano de Windows PowerShell.|
|[about_Job_Details [v4]](https://technet.microsoft.com/en-us/library/87511f90-984f-44d1-b869-8671b4181717)|Proporciona información detallada sobre los trabajos en segundo plano.|
|[about_Join [v4]](https://technet.microsoft.com/en-us/library/57acaf72-6b7d-44d7-8aa1-c521b0152198)|Describe el operador **Join**, que combina varias cadenas en una sola.|
|[about_Language_Keywords [v4]](https://technet.microsoft.com/en-us/library/36178a87-8055-4daf-b902-7880bb1b3490)|Describe las palabras clave del lenguaje de scripting de Windows PowerShell.|
|[about_Line_Editing [v4]](https://technet.microsoft.com/en-us/library/ada97e03-cbe4-477e-8817-98850fa5911f)|Describe las características de edición de la consola de Windows PowerShell.|
...
|[about_Operator_Precedence [v4]](https://technet.microsoft.com/en-us/library/ce3badd8-dd8d-4c75-b698-bf07304228ce)|Muestra los operadores de Windows PowerShell en orden de prioridad.|
|[about_Parameters [v4]](https://technet.microsoft.com/en-us/library/5a921ebf-e676-4984-affe-bba0b2118290)|Explica cómo trabajar con parámetros de cmdlet en Windows PowerShell.|
|[about_Parameters_Default_Values](https://technet.microsoft.com/en-us/library/a5fe8534-0b3d-45ec-8624-c52b694b9a01)|Explica cómo establecer valores predeterminados personalizados para los parámetros de cmdlet y funciones avanzadas.|
|[about_Parsing [v4]](https://technet.microsoft.com/en-us/library/df040a15-fb2c-461d-acdd-2a62a0a4d14d)|Explica cómo Windows PowerShell analiza los comandos.|
|[about_Path_Syntax [v4]](https://technet.microsoft.com/en-us/library/4d2789b0-8c37-4227-acf3-717a0bc155bc)|Describe los formatos de los nombres de las rutas de acceso completas y relativas en Windows PowerShell.|
|[about_Pipelines [v4]](https://technet.microsoft.com/en-us/library/f39a6658-4309-42a7-afe8-871bd4c6b01a)|Explica cómo combinar comandos en canalizaciones en Windows PowerShell.|
|[about_PowerShell.exe](https://technet.microsoft.com/en-us/library/d5548671-5362-4b0b-b22c-4360c71d7f26)|Muestra ayuda para la herramienta de línea de comandos PowerShell.exe.|
|[about_PowerShell_Ise.exe](https://technet.microsoft.com/en-us/library/f78d2891-de05-4403-8c91-e856abbd4fb6)|Muestra ayuda para la herramienta de línea de comandos PowerShell_ISE.exe.|
|[about_Preference_Variables [v4]](https://technet.microsoft.com/en-us/library/31344314-be29-4286-b039-afa5460cbe8b)|Describe las variables de preferencia que personalizan Windows PowerShell.|
|[about_Profiles [v4]](https://technet.microsoft.com/en-us/library/e1d9e30a-70cc-4f36-949f-fc7cd96b4054)|Explica cómo crear y usar un perfil de Windows PowerShell.|
|[about_Prompts [v4]](https://technet.microsoft.com/en-us/library/251843dc-4db3-4e21-aac6-acd3135b3ef6)|Explica cómo crear y usar un perfil de Windows PowerShell.|
|[about_Properties [v4]](https://technet.microsoft.com/en-us/library/2e8780bc-ed61-4644-a2bd-d614649bf14e)|Explica cómo usar propiedades de objetos en Windows PowerShell.|
|[about_Providers [v4]](https://technet.microsoft.com/en-us/library/2d9b3f32-be78-49ad-a547-21231c803242)|Describe los proveedores de Windows PowerShell y explica cómo usar los datos que exponen.|
|[about_PSSessions [v4]](https://technet.microsoft.com/en-us/library/747682ac-6499-4031-8dcc-5f22e831b549)|Describe las sesiones de Windows PowerShell (PSSessions) y explica cómo usarlas para ejecutar comandos remotos.|
|[about_PSSession_Details [v4]](https://technet.microsoft.com/en-us/library/d2c594e8-bcf6-4db5-8335-6487adcaf7eb)|Proporciona información detallada sobre las sesiones de Windows PowerShell.|
...
|[about_Quoting_Rules [v4]](https://technet.microsoft.com/en-us/library/295e444a-4219-40c6-b16f-3685c7c7bc52)|Explica las reglas de uso de las comillas simples y dobles en Windows PowerShell, incluidas las cadenas here-strings.|
...
|[about_Remote_FAQ [v4]](https://technet.microsoft.com/en-us/library/d1935955-4739-4281-8ac7-f26e470f29c1)|Preguntas y respuestas sobre la ejecución de comandos remotos en Windows PowerShell.|
|[about_Remote_Jobs [v4]](https://technet.microsoft.com/en-us/library/3d53e0b0-5974-46ef-b577-b1ed20bbef8f)|Explica cómo ejecutar trabajos en segundo plano en equipos remotos.|
...
|[about_Scheduled_Jobs_Troubleshooting](https://technet.microsoft.com/en-us/library/70de91e9-675f-4b5f-9179-6104b9cc4f0d)|Explica cómo resolver problemas en los trabajos programados.|
|[about_Scopes [v4]](https://technet.microsoft.com/en-us/library/807a5b29-3f02-4b97-8eed-854869936017)|Explica cómo establecer y cambiar el ámbito de funciones y variables en Windows PowerShell.|
|[about_Script_Blocks [v4]](https://technet.microsoft.com/en-us/library/d9468e4c-abe0-494e-a684-a74363042b9f)|Explica cómo usar bloques de script para combinar expresiones, instrucciones y comandos en un único bloque de código.|
...
|[about_Try_Catch_Finally [v4]](https://technet.microsoft.com/en-us/library/86a06c14-5b2e-4982-b02e-18be8424ae47)|El control de errores en los scripts se realiza mediante los bloques de script Try, Catch y Finally.|
|[about_Type_Operators [v4]](https://technet.microsoft.com/en-us/library/06c35762-56f7-4592-ad47-4f8f0047085e)|Describe los operadores que funcionan con tipos .NET.|
|[about_Types.ps1xml [v4]](https://technet.microsoft.com/en-us/library/bc879777-5cd6-45a9-96d8-ebe099b95456)|Describe los archivos Types.ps1xml que permiten ampliar los tipos .NET de los objetos usados en Windows PowerShell.|
|[about_Updatable_Help](https://technet.microsoft.com/en-us/library/10bba75c-f4ac-4ca1-bbf3-8f34dd521ffe)|Describe el sistema de ayuda actualizable en Windows PowerShell.|
|[about_Variables [v4]](https://technet.microsoft.com/en-us/library/0cb2aa2b-508a-4d25-999b-e066e99a9312)|Introducción que explica los tipos de variables en Windows PowerShell.|
|[about_While [v4]](https://technet.microsoft.com/en-us/library/3a1a1329-2501-4e4e-8660-a2ca68c68541)|Describe los bucles **While** en Windows PowerShell.|
|[about_Wildcards [v4]](https://technet.microsoft.com/en-us/library/9fe09a23-afce-4547-9e2f-c38090f77636)|Explica cómo usar el carácter comodín (\*) en Windows PowerShell.|
|[about_Windows_PowerShell_5.0](https://technet.microsoft.com/en-us/library/6d56fa88-371e-40c9-b2de-64a2a0cd49da)|Describe las características nuevas y los cambios en Windows PowerShell 4.0.|
|[about_Windows_PowerShell_ISE [v3]](https://technet.microsoft.com/en-us/library/dfa54d47-60c6-4fff-8197-c747e8d411bb)|Describe el Entorno de scripting integrado (ISE) de Windows PowerShell®.|
|[about_Workflows](https://technet.microsoft.com/en-us/library/f2897bdd-1b9d-4679-8b19-09840bd40a22)|Proporciona una breve introducción a la característica de flujo de trabajo de Windows PowerShell.|
|[about_WorkflowCommonParameters](https://technet.microsoft.com/en-us/library/119f968e-618e-439c-b76c-cdd17e6df27c)|Describe los parámetros que son válidos en todos los comandos de flujo de trabajo de Windows PowerShell.|
