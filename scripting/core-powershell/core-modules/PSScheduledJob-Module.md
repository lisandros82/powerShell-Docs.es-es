...
translationtype: HT
---
# <a name="psscheduledjob-module"></a>Módulo PSScheduledJob
Esta sección contiene los temas de Ayuda del módulo **PSScheduledJob**, con el que se administran tareas programadas en Windows PowerShell. Este módulo se instala con Windows PowerShell.

## <a name="help-topics"></a>Temas de Ayuda
[Cmdlet de trabajos programados de Windows PowerShell](http://go.microsoft.com/fwlink/?LinkID=245864)
