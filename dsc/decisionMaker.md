...
Centros de DSC alrededor de [configuraciones](configurations.md).
...
Las configuraciones también están [controladas por datos](configData.md), lo que facilita que los equipos de operaciones identifiquen y cambien los entornos sin intervención del programador.
...
Para las soluciones locales, DSC tiene un [servidor de extracción](pullServer.md) que puede utilizarse para centralizar la administración de máquinas e informar sobre su estado.
...
DSC también se puede usar para administrar Linux. Para más información, consulte [Introducción a la configuración de estado deseado (DSC) para Linux](lnxGettingStarted.md).
