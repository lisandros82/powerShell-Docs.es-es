...
Compruebe el archivo del esquema del recurso (*. schema.mof). Puede usar el [Diseñador de recursos de DSC](https://www.powershellgallery.com/packages/xDSCResourceDesigner/) como ayuda para desarrollar y probar su esquema.
Asegúrese de que:
