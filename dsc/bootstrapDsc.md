...
>**Nota:** la clave del Registro **DSCAutomationHostEnabled** descrita en este tema no está disponible en PowerShell 4.0.
...
Este comportamiento se especifica mediante la clave del Registro [DSCAutomationHostEnabled](DSCAutomationHostEnabled.md) en **HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies**.
...
1. Monte el VHD en el que desee insertar la configuración llamando al cmdlet [Mount-VHD](https://technet.microsoft.com/library/hh848551.aspx). Por ejemplo:
...
7. Cree una VM con el VHD donde instaló el documento MOF de DSC. Después de la instalación de sistema operativo y el arranque inicial, IIS se instalará.
...
1. Monte el VHD en el que desee insertar la metaconfiguración llamando al cmdlet [Mount-VHD](https://technet.microsoft.com/library/hh848551.aspx). Por ejemplo:
...
7. Desmonte el VHD mediante una llamada al cmdlet [Dismount-VHD](https://technet.microsoft.com/library/hh848562.aspx). Por ejemplo:
...
1. Monte el VHD llamando al cmdlet [Mount-VHD](https://technet.microsoft.com/library/hh848551.aspx). Por ejemplo:
...
3. Navegue hasta **HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\*** usando el proveedor de registro de PowerShell.
