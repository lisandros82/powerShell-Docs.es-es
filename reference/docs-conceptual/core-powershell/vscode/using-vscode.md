...
- **macOS**: siga las instrucciones de instalación de la página [Running VS Code on macOS](https://code.visualstudio.com/docs/setup/mac) (Ejecución de VS Code en macOS).
  ...
  > Ahora el código de VS puede cargar la extensión de PowerShell correctamente.
...
2. Aparecen dos paneles del editor.
...
3. Reemplace la configuración por la ruta de acceso al ejecutable de PowerShell deseado.
4. Guarde el archivo de configuración y reinicie Visual Studio Code.
...
- Asociar el depurador a un proceso de host de PowerShell
  ...
  3. Visual Studio Code le solicita que **seleccione un entorno**.
  Elija **PowerShell**.
