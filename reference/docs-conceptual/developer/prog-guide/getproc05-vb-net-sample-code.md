...
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="0dd07-102">Código de ejemplo GetProc05 (VB.NET)</span><span class="sxs-lookup"><span data-stu-id="0dd07-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="0dd07-103">Este es el código de VB.NET completo para el cmdlet de ejemplo GetProc05.</span><span class="sxs-lookup"><span data-stu-id="0dd07-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="0dd07-104">Véase también</span><span class="sxs-lookup"><span data-stu-id="0dd07-104">See Also</span></span>

[<span data-ttu-id="0dd07-105">Windows PowerShell SDK</span><span class="sxs-lookup"><span data-stu-id="0dd07-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)