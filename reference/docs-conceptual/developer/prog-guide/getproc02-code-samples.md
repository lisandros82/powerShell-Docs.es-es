...
Estos son los ejemplos de código para el cmdlet de ejemplo GetProc02. Este es el ejemplo de cmdlet `Get-Process` descrito en [agregar parámetros que procesan la entrada de la línea de comandos](../cmdlet/adding-parameters-that-process-command-line-input.md). Este cmdlet `Get-Process` recupera procesos según su nombre y, a continuación, muestra información sobre los procesos en la línea de comandos.
