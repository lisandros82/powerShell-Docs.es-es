...
Management OData IIS Extension utiliza archivos XML para definir la asignación de recursos. El siguiente XSD define el esquema que se usa para estos archivos.

## <a name="resource-mapping-file-xsd"></a>Archivo de asignación de recursos XSD

El siguiente XSD define el esquema para los archivos de asignación de recursos de extensión de IIS Management OData.
