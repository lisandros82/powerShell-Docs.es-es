...
---
# <a name="propertyname-element-for-expressionbinding-for-groupby-format"></a>Elemento PropertyName para ExpressionBinding for GroupBy (formato)

Especifica la propiedad de .NET cuyo valor muestra el control. Este elemento se utiliza al definir cómo se muestra un nuevo grupo de objetos.
