---
title: Ejemplo de Host04 | Microsoft Docs
ms.custom: ''
ms.date: 09/13/2016
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "72361034"
---
# <a name="host04-sample"></a><span data-ttu-id="9514a-102">Ejemplo Host04</span><span class="sxs-lookup"><span data-stu-id="9514a-102">Host04 Sample</span></span>

<span data-ttu-id="9514a-103">En este ejemplo se muestra cómo crear una aplicación host basada en consola interactiva que lee comandos desde la línea de comandos, ejecuta los comandos y, a continuación, muestra los resultados en la consola.</span><span class="sxs-lookup"><span data-stu-id="9514a-103">This sample shows how to build an interactive console-based host application that reads commands from the command line, executes the commands, and then displays the results to the console.</span></span> <span data-ttu-id="9514a-104">Esta aplicación host también permite mostrar avisos para que el usuario pueda especificar varias opciones.</span><span class="sxs-lookup"><span data-stu-id="9514a-104">This host application also supports displaying prompts that allow the user to specify multiple choices.</span></span>

## <a name="requirements"></a><span data-ttu-id="9514a-105">Requisitos</span><span class="sxs-lookup"><span data-stu-id="9514a-105">Requirements</span></span>

 <span data-ttu-id="9514a-106">Este ejemplo requiere Windows PowerShell 2,0.</span><span class="sxs-lookup"><span data-stu-id="9514a-106">This sample requires Windows PowerShell 2.0.</span></span>

## <a name="demonstrates"></a><span data-ttu-id="9514a-107">Demuestra</span><span class="sxs-lookup"><span data-stu-id="9514a-107">Demonstrates</span></span>

- <span data-ttu-id="9514a-108">Crear un host personalizado cuyas clases se deriven de la clase [System. Management. Automation. host. PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) , la clase [System. Management. Automation. host. Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) y el [ Clase System. Management. Automation. host. Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) .</span><span class="sxs-lookup"><span data-stu-id="9514a-108">Creating a custom host whose classes derive from the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class, the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class, and the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class.</span></span>

- <span data-ttu-id="9514a-109">Compilar una aplicación de consola que usa estas clases host para compilar un shell interactivo de Windows PowerShell.</span><span class="sxs-lookup"><span data-stu-id="9514a-109">Building a console application that uses these host classes to build an interactive Windows PowerShell shell.</span></span>

- <span data-ttu-id="9514a-110">Crear una variable `$profile` y cargar los siguientes perfiles.</span><span class="sxs-lookup"><span data-stu-id="9514a-110">Creating a `$profile` variable and loading the following profiles.</span></span>

  - <span data-ttu-id="9514a-111">usuario actual, host actual</span><span class="sxs-lookup"><span data-stu-id="9514a-111">current user, current host</span></span>

  - <span data-ttu-id="9514a-112">usuario actual, todos los hosts</span><span class="sxs-lookup"><span data-stu-id="9514a-112">current user, all hosts</span></span>

  - <span data-ttu-id="9514a-113">todos los usuarios, host actual</span><span class="sxs-lookup"><span data-stu-id="9514a-113">all users, current host</span></span>

  - <span data-ttu-id="9514a-114">todos los usuarios, todos los hosts</span><span class="sxs-lookup"><span data-stu-id="9514a-114">all users, all hosts</span></span>

- <span data-ttu-id="9514a-115">Implemente la interfaz [System. Management. Automation. host. Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) .</span><span class="sxs-lookup"><span data-stu-id="9514a-115">Implement the [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interface.</span></span>

## <a name="example"></a><span data-ttu-id="9514a-116">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="9514a-116">Example</span></span>

 <span data-ttu-id="9514a-117">Este ejemplo permite al usuario escribir comandos en una línea de comandos, procesa esos comandos y, a continuación, imprime los resultados.</span><span class="sxs-lookup"><span data-stu-id="9514a-117">This example allows the user to enter commands at a command line, processes those commands, and then prints out the results.</span></span>
...
## <a name="example"></a><span data-ttu-id="9514a-118">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="9514a-118">Example</span></span>

 <span data-ttu-id="9514a-119">El código siguiente es la implementación de la clase [System. Management. Automation. host. PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) que usa esta aplicación host.</span><span class="sxs-lookup"><span data-stu-id="9514a-119">The following code is the implementation of the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class that is used by this host application.</span></span> <span data-ttu-id="9514a-120">Los elementos que no se implementan inician una excepción o no devuelven nada.</span><span class="sxs-lookup"><span data-stu-id="9514a-120">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="example"></a><span data-ttu-id="9514a-121">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="9514a-121">Example</span></span>

 <span data-ttu-id="9514a-122">El código siguiente es la implementación de la clase [System. Management. Automation. host. Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) que usa esta aplicación host.</span><span class="sxs-lookup"><span data-stu-id="9514a-122">The following code is the implementation of the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class that is used by this host application.</span></span>
...
## <a name="example"></a><span data-ttu-id="9514a-123">Ejemplo</span><span class="sxs-lookup"><span data-stu-id="9514a-123">Example</span></span>

 <span data-ttu-id="9514a-124">El código siguiente es la implementación de la clase [System. Management. Automation. host. Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) usada por esta aplicación host.</span><span class="sxs-lookup"><span data-stu-id="9514a-124">The following code is the implementation of the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class that is used by this host application.</span></span> <span data-ttu-id="9514a-125">Los elementos que no se implementan inician una excepción o no devuelven nada.</span><span class="sxs-lookup"><span data-stu-id="9514a-125">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="9514a-126">Véase también</span><span class="sxs-lookup"><span data-stu-id="9514a-126">See Also</span></span>

 [<span data-ttu-id="9514a-127">System. Management. Automation. host. PSHost</span><span class="sxs-lookup"><span data-stu-id="9514a-127">System.Management.Automation.Host.PSHost</span></span>](/dotnet/api/System.Management.Automation.Host.PSHost)

 [<span data-ttu-id="9514a-128">System. Management. Automation. host. Pshostuserinterface</span><span class="sxs-lookup"><span data-stu-id="9514a-128">System.Management.Automation.Host.Pshostuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)

 [<span data-ttu-id="9514a-129">System. Management. Automation. host. Pshostrawuserinterface</span><span class="sxs-lookup"><span data-stu-id="9514a-129">System.Management.Automation.Host.Pshostrawuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)
