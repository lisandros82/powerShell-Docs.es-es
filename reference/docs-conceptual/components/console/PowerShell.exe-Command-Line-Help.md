...
> [!NOTE]
> Nota para la solución de problemas: En PowerShell 2.0, al iniciar algunos programas en Windows PowerShell se produce un error en la consola de un error lastexitcode 0xc0000142.
